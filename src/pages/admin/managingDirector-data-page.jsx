  ...
  const fetchSheetData = useCallback(async () => {
    try {
      ...
      rows.forEach((row, rowIndex) => {
        ...
        // Consider as history if Actual date (K) or Status (M) is filled
        const isHistory = hasColumnG && (!isColumnKEmpty || !isColumnMEmpty);

        if (hasColumnG && !isHistory) {
          ...
          // At this point we've already filtered by user/admin above
                        ...
                        <tr key={history._id} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <input
                              ...
                              onChange={(e) =>
                                handleHistoryItemSelection(history._id, e.target.checked)
                              }
                            />
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
